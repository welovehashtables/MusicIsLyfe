...
<a class="py-2 d-none d-md-inline-block" href="../findmusic.html">Find Music</a>
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
      	...
      	<head>
              	<title>Song Name Info</title>
        </head>

        <body>

              	<?php
			$songname = $_POST['inputSname'];			
                        ...
                        $sql = "SELECT S.songID,U.Username,S.Title
				FROM Song S,Collaborates C,User U
			...
			if ($result->num_rows > 0){
                        while($row = $result->fetch_assoc()){
                                echo "SongID: ".$row["songID"]. "| title: ".$row["Title"]."| artist: ".$row["Username"];
				echo "<br>";
                        }}
			else {	echo "0 results";}
                        $conn->close();
